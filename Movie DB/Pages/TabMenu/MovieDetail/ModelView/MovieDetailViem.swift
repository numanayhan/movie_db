...
class MovieDetailViem {
    ...
    func movieDetail(_ movieId:Int, completion : @escaping (MoviesDetail) ->Void ){
        ...
        GenericRequest.shared.genericRequest(request: request, expecting: MoviesDetail.self) { results in
            switch results {
